...
(
    `instance_id`      bigint      NOT NULL COMMENT '主键ID',
    ...
    `updator_name`     varchar(50)          DEFAULT NULL COMMENT '上次更新人',
...
(
    `task_id`        bigint       NOT NULL COMMENT '主键ID',
    `tenant_id`      bigint       NOT NULL DEFAULT '0' COMMENT '租户ID',
    `creator_id`     bigint       NOT NULL DEFAULT '0' COMMENT '创建人ID',
    `creator_name`   varchar(50)  NOT NULL COMMENT '创建人',
    ...
    `assignor`       varchar(100)          DEFAULT NULL COMMENT '委托人',
...
(
    `task_actor_id` bigint       NOT NULL COMMENT '主键 ID',
    `tenant_id`     bigint       NOT NULL DEFAULT '0' COMMENT '租户ID',
    `instance_id`   bigint       NOT NULL COMMENT '流程实例ID',
...
(
    `process_id`      bigint       NOT NULL COMMENT '主键ID',
    `tenant_id`       bigint       NOT NULL DEFAULT '0' COMMENT '租户ID',
    `creator_id`      bigint       NOT NULL DEFAULT '0' COMMENT '创建人ID',
    `creator_name`    varchar(50)  NOT NULL COMMENT '创建人',
    `create_time`     timestamp    NOT NULL COMMENT '创建时间',
...
(
    ...
    `action_url`     varchar(200)          DEFAULT NULL COMMENT '任务处理的url',
    `variable`       json                  DEFAULT NULL COMMENT '变量json',
    `assignor_id`    bigint                DEFAULT NULL COMMENT '委托人ID',
    `assignor_name`  varchar(100)          DEFAULT NULL COMMENT '委托人',
    `expire_time`    timestamp    NULL     DEFAULT NULL COMMENT '任务期望完成时间',
    `remind_time`    timestamp    NULL     DEFAULT NULL COMMENT '提醒时间',
    `remind_repeat`  tinyint(1)   NOT NULL DEFAULT '0' COMMENT '提醒次数',
    `viewed`         tinyint(1)   NOT NULL DEFAULT '0' COMMENT '已阅 0，否 1，是',
...
(
    `task_cc_id`     bigint       NOT NULL COMMENT '主键ID',
    `tenant_id`      bigint       NOT NULL DEFAULT '0' COMMENT '租户ID',
    `creator_id`     bigint       NOT NULL DEFAULT '0' COMMENT '创建人ID',
    `creator_name`   varchar(50)  NOT NULL COMMENT '创建人',
    `create_time`    timestamp    NOT NULL COMMENT '创建时间',
