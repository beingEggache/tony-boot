...
internal class ProcessServiceImpl(
    ...
    override fun deploy(modelContent: String, flowCreator: FlowOperator, repeat: Boolean): Long {
        ...
        val processVersion = flowProcessMapper
            .ktQuery()
        ...
        val flowProcess = FlowProcess().apply {
    ...
    override fun redeploy(processId: Long, modelContent: String): Boolean {
        val flowProcess = flowProcessMapper
