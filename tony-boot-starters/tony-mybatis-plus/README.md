...
class CustomApiSession : ApiSession {
    override val userId: String get() = TODO()// 从Token或上下文获取
    override val userName: String get() = TODO()// ...
    override val orgId: String get() = TODO()// ...
    override val orgName: String get() = TODO()// ...
    override val tenantId: String get() = TODO()// ...
}
```
