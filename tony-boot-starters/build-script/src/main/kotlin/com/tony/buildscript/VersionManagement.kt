...
object VersionManagement  {
    ...
    const val reactorVersion = "3.4.25"
    const val reactorKotlinExtensions = "1.2.0"
    const val reactorNettyVersion = "1.1.0"
    const val slf4jVersion = "1.7.36"

    const val byteBuddyVersion = "1.12.19"
