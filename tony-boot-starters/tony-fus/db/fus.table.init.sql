...
(
    ...
    `use_scope`       smallint     NOT NULL DEFAULT '1' COMMENT '使用范围: 1.全员, 2.指定人员（业务关联）, 3.均不可提交',
...
(
    ...
    `task_state`     smallint     NOT NULL DEFAULT '1' COMMENT '任务状态: 1.活动, 2.完成, 3.拒绝, 4.超时, 5.终止',
    PRIMARY KEY (`task_id`) USING BTREE,
