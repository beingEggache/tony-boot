...
public class MysqlTest extends TestFlowLong {
    ...
    protected FlowCreator testCreator = FlowCreator.Companion.of(testUser1, "测试001");
    protected FlowCreator test2Creator = FlowCreator.Companion.of(testUser2, "测试002");
    protected FlowCreator test3Creator = FlowCreator.Companion.of(testUser3, "测试003");
