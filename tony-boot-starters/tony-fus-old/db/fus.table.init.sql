...
(
    ...
    `task_type`      smallint     NOT NULL COMMENT '1.主办, 2.审批, 3.抄送, 4.条件审批, 5.条件分支, 6.子流程, 7.定时器, 8.触发器, 11.转办, 12.委派, 13.委派归还, 14.代理人任务, 15.代理人归还任务, 16.代理协办完成的任务, 17.被代理人自己完成的任务',
