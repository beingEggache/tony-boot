...
object Deps {
    ...
    object TonyBoot {
        const val tonyAlipay = "com.tony:tony-alipay:${Version.tonyBootVersion}"
        const val tonyAliyunOss = "com.tony:tony-aliyun-oss:${Version.tonyBootVersion}"
        const val tonyAliyunSms = "com.tony:tony-aliyun-sms:${Version.tonyBootVersion}"
        const val tonyCache = "com.tony:tony-cache:${Version.tonyBootVersion}"
        const val tonyCore = "com.tony:tony-core:${Version.tonyBootVersion}"
        const val tonyHttp = "com.tony:tony-http:${Version.tonyBootVersion}"
        const val tonyKnife4j = "com.tony:tony-knife4j:${Version.tonyBootVersion}"
        const val tonyKnife4jApi = "com.tony:tony-knife4j-api:${Version.tonyBootVersion}"
        const val tonyWebCore = "com.tony:tony-web-core:${Version.tonyBootVersion}"
        const val tonyWechat = "com.tony:tony-wechat:${Version.tonyBootVersion}"
    }
