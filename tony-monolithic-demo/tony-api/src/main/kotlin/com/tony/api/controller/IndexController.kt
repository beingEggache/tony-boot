...
import com.tony.api.MonoApiWebContext.appId
import com.tony.api.MonoApiWebContext.tenantId
import com.tony.api.permission.NoPermissionCheck
import com.tony.db.service.IndexService
import com.tony.dto.req.ChangePwdReq
import com.tony.dto.req.LoginReq
import com.tony.dto.resp.InfoResp
import com.tony.dto.resp.LoginResp
...
class IndexController(
    ...
    fun login(
        ...
        return LoginResp(token, token, LocalDateTime.now().minusMinutes(jwtProperties.expiredMinutes))
    }
