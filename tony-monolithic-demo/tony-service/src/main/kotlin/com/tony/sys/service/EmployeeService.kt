...
import com.tony.sys.dao.DeptDao
import com.tony.sys.dao.EmployeeDao
import com.tony.sys.dao.RoleDao
import com.tony.sys.dto.req.EmployeeAddReq
import com.tony.sys.dto.req.EmployeeAssignRoleReq
import com.tony.sys.dto.req.EmployeeDetailReq
import com.tony.sys.dto.req.EmployeeQuery
import com.tony.sys.dto.req.EmployeeResetPwdReq
import com.tony.sys.dto.req.EmployeeToggleEnabledReq
import com.tony.sys.dto.req.EmployeeUpdateReq
...
class EmployeeService(
    ...
    private fun resetPwd(po: Employee) {
        ...
        po.accountState = com.tony.sys.dto.enums.AccountState.NEED_CHANGE_PWD
        employeeDao.updateById(po)
    }
}
